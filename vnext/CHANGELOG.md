...
- Bump @react-native-windows/cli to v0.74.14
...
- Bump @react-native-windows/cli to v0.74.13
...
Mon, 17 Nov 2025 16:33:43 GMT

### Patches

- Add TSF support to TextInput (30809111+acoates-ms@users.noreply.github.com)
- Use hermes-windows 0.0.0-2511.7001-d7ca19b3 (vmorozov@microsoft.com)
- Narrator doesn't follow focus (30809111+acoates-ms@users.noreply.github.com)
...
- Bump @react-native-windows/cli to v0.74.7
...
- Bump @react-native-windows/cli to v0.74.5
- Bump @react-native-windows/codegen to v0.74.3
...
- Bump @react-native-windows/cli to v0.74.0-preview.2
...
- Fix desktop dll build when fabric is enabled (30809111+acoates-ms@users.noreply.github.com)
...
- Revert 10863 (34109996+chiaramooney@users.noreply.github.com)
...
- [Image] Fix rendering statically sized svgs (email not defined)
...
- Bump @react-native-windows/codegen to v0.0.0-canary.25
...
- Bump @react-native-windows/codegen to v0.0.0-canary.24
...
- Fixes onMouseEnter/Leave to fire when pointer down (erozell@outlook.com)
...
- Catch and report errors in linking module (asklar@microsoft.com)
